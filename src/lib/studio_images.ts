...
export type inspected_cos_object = { sha256: string; version_id?: string; studio_request_id?: string };
export interface cos_adapter { verify_versioning(): Promise<void>; inspect_object(object_key: string): Promise<inspected_cos_object | undefined>; upload_object(input: prepared_image, studio_request_id?: string): Promise<{ version_id: string }>; delete_object(object_key: string, version_id: string): Promise<void>; }
